  ...
  return <section id="services" ref={ref} className="py-24 relative overflow-hidden bg-gradient-to-br from-white via-red-50/30 to-gray-50">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        duration: 0.6
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-body">Program-program NEUTRON Bandung 2 terbukti berhasil membimbing lebih dari 1.000 siswa setiap tahunnya di wilayah Buah Batu, Kota Bandung. Temukan program yang paling cocok denganmu.</p>
        </motion.div>
